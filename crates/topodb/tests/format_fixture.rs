//! Committed format fixtures. `v1.redb` is frozen migration input; `v2.redb`
//! is generated by this build and pins the current native layout.
//!
...
fn regenerate_fixture() {
    let path = std::path::Path::new(env!("CARGO_MANIFEST_DIR")).join("tests/fixtures/v2.redb");
